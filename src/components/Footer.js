            ...
            <div className="footer-search">
              ...
              <form className="search-form">
                ...
                <div className="popular-searches">
                  ...
                  <a href="#search-diabetes" className="search-tag">Diabetes</a>
                  <a href="#search-stress" className="search-tag">Stress Relief</a>
                  <a href="#search-immunity" className="search-tag">Immunity</a>
                  <a href="#search-digestion" className="search-tag">Digestion</a>
                </div>
              </form>
            </div>
          </div>
