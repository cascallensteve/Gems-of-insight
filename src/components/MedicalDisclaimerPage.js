...
import './MedicalDisclaimerPage.css';
  ...
  return (
    <div className="disclaimer-page">
      <div className="disclaimer-container">
        {/* Navigation Header */}
        <div className="disclaimer-navigation">
          ...
          <h1 className="disclaimer-title">Medical Disclaimer</h1>
        </div>
        ...
        <div className="disclaimer-content">
          ...
          <div className="disclaimer-section">
            ...
            <p>While herbal remedies have been used traditionally for centuries, it's important to understand:</p>
            <ul>
