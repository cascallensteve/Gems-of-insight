...
const CheckoutPage = () => {
  ...
  const counties = [
    ...
    'Nyeri', 'Meru', 'Embu', 'Garissa', 'Kakamega', 'Kitale', 'Machakos'
  ];
        ...
        <div className="checkout-container">
          <div className="order-success">
            ...
            <div className="order-summary">
              ...
              <p><strong>Payment Method:</strong> {paymentMethod === 'mpesa' ? 'M-Pesa' : paymentMethod}</p>
              ...
              <div className="review-step">
                ...
                <div className="review-sections">
                  ...
                  <div className="review-section">
                    ...
                    <div className="review-content">
                      <p>{paymentMethod === 'mpesa' ? `M-Pesa (${mpesaPhone})` : 'Cash on Delivery'}</p>
                    </div>
                  </div>
