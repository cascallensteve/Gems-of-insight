      ...
      <div className="courses-container">
        ...
        <motion.section className="premium-videos-section" variants={itemVariants}>
          ...
          <div className="videos-grid">
            ...
            <div className="video-card locked">
              <div className="video-thumbnail">
                <img src="https://res.cloudinary.com/dqvsjtkqw/image/upload/w_400,h_250,c_fill/v1750921889/logs_co58wn.jpg" alt="Digestive Health Solutions" loading="lazy" />
                <div className="video-overlay">
                  <div className="lock-icon">🔒</div>
                  <div className="play-button">▶</div>
                </div>
                <div className="video-duration">18:20</div>
              </div>
              <div className="video-info">
                <h3>Digestive Health Solutions</h3>
                <p>Natural approaches to improving digestive health and gut wellness.</p>
                <div className="video-meta">
                  <span className="difficulty">Beginner</span>
                  <span className="price">KES 600</span>
                </div>
                <button className="unlock-btn">
                  <span className="lock-icon">🔓</span>
                  Unlock Video
            ...
            <div className="video-card locked featured">
              <div className="featured-badge">Most Popular</div>
              <div className="video-thumbnail">
                <img src="https://res.cloudinary.com/dqvsjtkqw/image/upload/w_400,h_250,c_fill/v1753707168/medium-shot-doctor-holding-smartphone_yq2rkh.jpg" alt="Complete Wellness Protocol" loading="lazy" />
                <div className="video-overlay">
                  <div className="lock-icon">🔒</div>
                  <div className="play-button">▶</div>
                </div>
                <div className="video-duration">35:15</div>
              </div>
              <div className="video-info">
                <h3>Complete Wellness Protocol</h3>
                <p>Comprehensive wellness approach combining traditional and modern methods.</p>
                <div className="video-meta">
                  <span className="difficulty">Advanced</span>
                  <span className="price">KES 1,200</span>
                </div>
                <button className="unlock-btn featured-btn">
                  <span className="lock-icon">🔓</span>
                  Unlock Premium
                </button>
              </div>
            ...
            <div className="video-card locked">
              <div className="video-thumbnail">
                <img src="https://res.cloudinary.com/dqvsjtkqw/image/upload/w_400,h_250,c_fill/v1755234643/young-woman-with-curly-hair-sitting-cafe_f7fhfp.jpg" alt="Stress Management Techniques" loading="lazy" />
                <div className="video-overlay">
                  <div className="lock-icon">🔒</div>
                  <div className="play-button">▶</div>
                </div>
                <div className="video-duration">28:10</div>
              </div>
              <div className="video-info">
                <h3>Stress Management Techniques</h3>
                <p>Natural methods to manage stress and improve mental wellness.</p>
                <div className="video-meta">
                  <span className="difficulty">Intermediate</span>
                  <span className="price">KES 800</span>
                </div>
                <button className="unlock-btn">
                  <span className="lock-icon">🔓</span>
                  Unlock Video
            ...
            <div className="video-card locked">
              <div className="video-thumbnail">
                <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=400&h=250&fit=crop" alt="Immune System Boosting" loading="lazy" />
                <div className="video-overlay">
                  <div className="lock-icon">🔒</div>
                  <div className="play-button">▶</div>
                </div>
                <div className="video-duration">20:30</div>
              </div>
              <div className="video-info">
                <h3>Immune System Boosting</h3>
                <p>Natural ways to strengthen your immune system through nutrition and herbs.</p>
                <div className="video-meta">
                  <span className="difficulty">Beginner</span>
                  <span className="price">KES 650</span>
                </div>
                <button className="unlock-btn">
                  <span className="lock-icon">🔓</span>
                  Unlock Video
